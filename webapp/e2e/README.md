# End-to-end tests — Compliance Tracking
...
Use another port if `8183` is taken:
...
| 7 | Local persistence | An assessment created **by the test itself** through the "Contexte" form autosaves to `localStorage` and is still there after a reload — no fixture file, no server |
