...
interface ComplianceMesureType {
    ...
    /** Fields carried by a proposal coming from the reference-measures catalog. */
    ref_id?: string;
    csf_function?: string;
...
/** Reference measure from the window.COMPLIANCE_REFERENCE_CONTROLS catalog. */
...
/** Backend API client (absent in opensource — loaded by compliance_api.js in suite mode). */
