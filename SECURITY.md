...
- **Sessions are issued and verified by this module alone.** `JWT_SECRET` is a
  ...
  `HKDF-SHA256(JWT_SECRET, salt="ciso-suite/jwt-key/v1", info="ciso-module:compliance")`
  and tokens carry `aud=ciso-module:compliance`. A token minted by another module -
